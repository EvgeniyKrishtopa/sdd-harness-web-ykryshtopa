...
| `.claude/harness.json` | Steps 2e, 8, 8b | merge keys (including `webQaScenariosDir`, added 0.4.0, and `disabledRules` and `models.clarify`, both added 0.5.0 — see Step 8); never drop keys already there |
